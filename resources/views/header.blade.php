...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark col-md-12 ">
  <a class="navbar-brand" href="#"><i class="fas fa-shipping-fast"></i> मेरो सपिङ<br/><div class="pl-4">My Shopping</div></a>
  ...
  <div class="collapse navbar-collapse d-flex justify-content-end " id="navbarSupportedContent">
    ...
    <li class="nav-item"> <div> <a class="nav-link px-5" href="{{url('orders')}}">Orders</a></div></li>
    <li class="nav-item"> <div> <a class="nav-link px-5" href="{{ url('/brands') }}">Brands</a></div></li>
...
<style type="text/css">@import url(https://fonts.googleapis.com/css?family=Nunito);
