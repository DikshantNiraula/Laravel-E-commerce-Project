...
<div class="producthead"><h1 class="pt-5">सामानहरु  <i class="far fa-smile"></i>    </h1>
<a href="{{url('products/create')}}" style="background-color:#FFFFE0 "><i class="fas fa-plus-circle"></i>Add</a></div>
</br>
<style>
    .producthead{
...
<a href="{{route('products.show',$product->id)}}" style="color:black">
  ...
  <div class="card-body">
    ...
    <div style="background-color:gray" class="baseline-alignment"><h4 class="text-left">Rs.<div style="color:yellow">{{$product->price}} Only</h4>
    </div>
<div class="content">
